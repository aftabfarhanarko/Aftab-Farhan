...
const Services = () => {
  ...
  const techStack = [
    { name: "JavaScript", color: "bg-yellow-400/15 text-yellow-400 border-yellow-400/30" },
    { name: "TypeScript", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
    { name: "React.js", color: "bg-cyan-400/15 text-cyan-400 border-cyan-400/30" },
    { name: "Next.js", color: "bg-foreground/10 text-foreground border-border" },
    { name: "React Native", color: "bg-cyan-500/15 text-cyan-500 border-cyan-500/30" },
    { name: "Node.js", color: "bg-green-500/15 text-green-400 border-green-500/30" },
    { name: "Express.js", color: "bg-foreground/10 text-foreground/70 border-border" },
    { name: "PostgreSQL", color: "bg-blue-600/15 text-blue-400 border-blue-600/30" },
    { name: "MySQL", color: "bg-orange-500/15 text-orange-400 border-orange-500/30" },
    { name: "MongoDB", color: "bg-green-600/15 text-green-500 border-green-600/30" },
    { name: "Mongoose", color: "bg-red-500/15 text-red-400 border-red-500/30" },
    { name: "Redis", color: "bg-red-600/15 text-red-500 border-red-600/30" },
    { name: "GraphQL", color: "bg-pink-500/15 text-pink-400 border-pink-500/30" },
    { name: "REST API", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
    { name: "Docker", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
    { name: "AWS", color: "bg-orange-400/15 text-orange-400 border-orange-400/30" },
    { name: "Prisma ORM", color: "bg-teal-500/15 text-teal-400 border-teal-500/30" },
    { name: "Tailwind CSS", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
    ...
    { name: "Stripe", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
