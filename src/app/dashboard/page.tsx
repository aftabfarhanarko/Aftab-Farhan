...
const DashboardOverview = () => {
  const stats = [
    ...
    { label: "Skills", value: "24", icon: "🛠️", color: "bg-yellow-500/10 text-yellow-500" },
  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <div className="text-[10px] font-bold uppercase tracking-widest text-foreground/30">{stat.label}</div>
          </motion.div>
        ))}
      </div>
      ...
      {/* Quick Actions */}
      <div className="mb-12">
        <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-foreground/30 mb-6 px-1">Quick Actions</h2>
            ...
            <Link href={action.href} key={i}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/40 font-medium">{action.desc}</p>
                </div>
              </motion.div>
            </Link>
          ))}
      ...
      <div className="p-8 rounded-[2.5rem] bg-green-500/5 border border-green-500/10 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-sm font-bold text-green-500/80 uppercase tracking-widest">Backend Connected</span>
        </div>
